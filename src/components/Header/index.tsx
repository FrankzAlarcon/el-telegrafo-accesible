...
const MoonIcon = (): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" role='button' aria-label='Activar Dark Mode' fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="ml-[2px] mt-[2px] w-6 h-6">
...
const SunIcon = (): JSX.Element => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" role='button' aria-label='Activar Ligth Mode' fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="ml-1 pt-[2px] w-6 h-6">
